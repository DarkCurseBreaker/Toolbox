...
setblock 199 72 -21 structure_block{mode: "LOAD", name: "hammer:nail/nail5", ignoreEntities: false, showboundingbox:false} destroy
#
...
setblock 199 73 -21 redstone_block
#
