...
function hammer:in_game/redux/teamspawnset
scoreboard players set @a[team=def] Respawn 17
gamerule doMobSpawning true
gamerule doDaylightCycle true
time set 16000
difficulty hard
schedule function hammer:in_game/redux/gametimerstart 76s
function hammer:in_game/redux/spongecheck
function hammer:in_game/redux/defrespawntimer
function hammer:in_game/redux/defspawndoorclose
function hammer:in_game/redux/defspawndooropen