execute if entity @a[scores={Respawn=..0},team=def] run execute at @a[scores={Respawn=..0},team=def] run function hammer:in_game/redux/defrespawn
...
schedule function hammer:in_game/redux/defrespawntimer 1s